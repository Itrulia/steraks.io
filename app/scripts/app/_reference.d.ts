...
/// <reference path='resource/SummonerResource.ts' />
/// <reference path='service/SummonerService.ts' />

/// <reference path='resource/StaticResource.ts' />
/// <reference path='service/StaticService.ts' />
